 ...
 */
class CommentaireNews extends \Pes\FrontBundle\Entity\CommentaireNews implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'titre', 'contenu', 'date', 'news');
    }
